...
import { freeSubscription } from '../../assets/constants'
...
const Cards = () => {
  return (
    <div className="flex flex-row gap-3 ">
        ...
        <div className="bg-white mt-10 rounded-md pb-12">
            <div className="flex flex-col pt-10 mx-12">
                <div className="flex flex-col items-center justify-center pb-8">
                    <h2 className="font-semibold text-lg md:text-xl lg:text-2xl">Starter</h2>
                ...
                <button className="bg-blue-600 p-2 ml-8 rounded-md w-32 ">Get Started</button>
             
            </div>
        </div>

        <div className="bg-black mt-10 rounded-md pb-12">
            <div className="flex flex-col pt-10 mx-12">
                <div className="flex flex-col items-center justify-center pb-8">
                    <h2 className="font-semibold text-lg md:text-xl lg:text-2xl">Pro</h2>
